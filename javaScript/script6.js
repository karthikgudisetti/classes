...
let student={
         ...
         let EmployeData=JSON.parse(Employees);
...
let myobj_copy={...myobj};//hybrid copy or shellow copy
// console.log(myobj);
// console.log(myobj_copy);


//deep copy
let n_obj=JSON.parse(JSON.stringify(myobj_copy));
n_obj.interests.push("playing");
console.log(n_obj);
console.log(myobj);
console.log(myobj_copy);