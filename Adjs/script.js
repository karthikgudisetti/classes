...
employees.forEach((emp) => {
    users+=1;
    count += emp.products_in_cart.length;
    emp.products_in_cart.forEach(item=>{
       amount+=item.cost
    })
});
...
document.getElementById('gst').innerHTML="GST RATE"
document.getElementById('gstp').innerHTML=gst;
document.getElementById('user1').innerHTML=users;
...
let juniorBody = document.getElementById("juniorBody");
